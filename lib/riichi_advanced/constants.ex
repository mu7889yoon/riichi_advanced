defmodule RiichiAdvanced.Constants do
  ...
  @unimplemented_rulesets [
    ...
    {"visayan", "Visayan", "16-tile mahjong where you can form dragon and wind sequences.",
     "https://mahjongpros.com/blogs/how-to-play/beginners-guide-to-filipino-visayan-mahjong"},
    {"changsha", "Changsha",
     "Mahjong, but every win gets two chances at ura dora. However, a standard hand must have a pair of 22, 55, or 88.",
     "https://mahjongpros.com/blogs/how-to-play/beginners-guide-to-changsha-mahjong"},
    {"shenyang", "Shenyang",
     ...
     "https://peterish.com/riichi-docs/shenyang-mahjong-rules/"},
    {"korean", "Korean",
     "Like Riichi but with a two-han minimum. There is also a side race to see who reaches three wins first.",
     "https://mahjongpros.com/blogs/mahjong-rules-and-scoring-tables/official-korean-mahjong-rules"},
    {"british", "British", "No description provided.",
     "https://wonderfuloldthings.wordpress.com/wp-content/uploads/2013/09/british-rules-guide-to-mahjong-v2-1.pdf"},
    {"italian", "Italian", "No description provided.",
     "https://www.fimj.it/wp-content/uploads/2012/01/111213_Regolamento_FIMJ_A4.pdf"},
    {"dutch", "Dutch", "No description provided.",
     "https://mahjongbond.org/wp-content/uploads/2019/10/NMB-NTS-Spelregelboekje.pdf"},
    {"german", "German", "No description provided.",
     "https://www-user.tu-chemnitz.de/~sontag/mahjongg/"},
    {"french", "French", "No description provided.",
     "https://web.archive.org/web/20050203025449/http://mahjongg.free.fr/Regles.php3"},
    {"australian", "Australian", "No description provided.",
     "https://balsallcommonu3a.org/Downloads/Mahjong%20Rules%20November%202016.pdf"}
  ]
  ...
  @modpacks %{
    "riichi" => %{
      display_name: "Riichi",
      tutorial_link:
        "https://github.com/EpicOrange/riichi_advanced/blob/main/documentation/riichi.md",
      ruleset: "riichi",
      globals: %{
        chii_name: "Chii",
        pon_name: "Pon",
    ...
    "sanma" => %{
      display_name: "Sanma",
      tutorial_link:
        "https://github.com/EpicOrange/riichi_advanced/blob/main/documentation/sanma.md",
      ruleset: "riichi",
    ...
    "cosmic" => %{
      ...
      tutorial_link:
        "https://docs.google.com/document/d/1F-NhQ5fdi5CnAyEqwNE_qWR0Og99NtCo2NGkvBc5EwU/edit",
      ruleset: "riichi",
      mods: ["cosmic_base"],
    ...
    "nojokersmahjongleague" => %{
      ...
      tutorial_link:
        "https://docs.google.com/document/d/1APpd-YBnsKKssGmyLQiCp90Wk-06SlIScV1sKpJUbQo/edit?usp=sharing",
      ruleset: "riichi",
      mods: [
        "kiriage_mangan",
        "agarirenchan",
    ...
    "galaxy" => %{
      ...
      tutorial_link:
        "https://github.com/EpicOrange/riichi_advanced/blob/main/documentation/galaxy.md",
      ruleset: "riichi",
      mods: ["galaxy"],
      default_mods: []
    },
    "chinitsu" => %{
      ...
      tutorial_link:
        "https://github.com/EpicOrange/riichi_advanced/blob/main/documentation/chinitsu_challenge.md",
      ruleset: "riichi",
    ...
    "kansai" => %{
      ...
      tutorial_link:
        "https://github.com/EpicOrange/riichi_advanced/blob/main/documentation/kansai.md",
      ruleset: "riichi",
    ...
    "hk" => %{
      ...
      tutorial_link:
        "https://github.com/EpicOrange/riichi_advanced/blob/main/documentation/hk.md",
      ruleset: "hk",
      globals: %{
        chii_name: "Chow",
        pon_name: "Pong",
      ...
      mods: [
        ...
        %{
          ...
          config: %{
            list: "yaku",
            rinshan_name: "After a Kong",
            flower_name: "After a Flower",
            value: 1,
            double_list: "yaku",
            double_name: "After Multiple Kongs",
            double_value: 8
          }
        },
        ...
        %{
          ...
          config: %{
            hon_list: "yaku",
            hon_name: "Mixed Terminals",
            hon_value: 4,
            chin_list: "yaku",
            chin_name: "All Terminals",
            chin_value: 13
          }
        },
        ...
        %{
          ...
          config: %{
            haitei_list: "yaku",
            haitei_name: "Final Tile",
            haitei_value: 1,
            houtei_list: "yaku",
            houtei_name: "Final Tile",
            houtei_value: 1
          }
        },
        %{
          name: "yaku/suuankou",
          config: %{list: "yaku", name: "Four Concealed Triplets", value: 8}
        },
        ...
        %{
          ...
          config: %{
            shou_list: "yaku",
            shou_name: "Little Three Dragons",
            shou_value: 5,
            dai_list: "yaku",
            dai_name: "Big Three Dragons",
            dai_value: 8
          }
        },
        %{
          name: "yaku/daisuushii",
          config: %{
            shou_list: "yaku",
            shou_name: "Little Four Winds",
            shou_value: 6,
            dai_list: "yaku",
            dai_name: "Big Four Winds",
            dai_value: 13
          }
        },
        %{
          ...
          config: %{
            tenhou_list: "yaku",
            tenhou_name: "Blessing of Heaven",
            tenhou_value: 13,
            chiihou_list: "yaku",
            chiihou_name: "Blessing of Earth",
            chiihou_value: 13,
            renhou_list: "yaku",
            renhou_name: "Blessing of Man",
            renhou_value: 13,
            chiihou_is_tsumo: false,
            renhou_disabled: false
          }
        }
      ]
    },
    "classical" => %{
      ...
      mods: [
        ...
        "kan",
        "head_bump",
        # should go after chii/pon/kan/ron/chankan/tsumo
        %{name: "default_flowers", config: %{unskippable: true, four_flowers_value: 4}},
        ...
        %{
          ...
          config: %{
            list: "yaku",
            rinshan_name: "Out on a Replacement",
            flower_name: "Out on a Replacement",
            value: 1,
            double_list: "yakuman",
            double_name: "Two-Fold Fortune",
            double_value: 1
          }
        },
        %{
        ...
        %{
          ...
          config: %{
            hon_list: "yaku",
            hon_name: "All Terminals and Honors",
            hon_value: 1,
            chin_list: "yakuman",
            chin_name: "All Terminals",
            chin_value: 1
        ...
        %{
          ...
          config: %{
            haitei_list: "yaku",
            haitei_name: "Last Tile Draw",
            haitei_value: 1,
            houtei_list: "yaku",
            houtei_name: "Last Tile Discard",
            houtei_value: 1
          }
        },
        %{
          name: "yaku/sanankou",
          config: %{list: "yaku", name: "Three Concealed Triplets", value: 1}
        },
        %{
          name: "yaku/suuankou",
          config: %{list: "yakuman", name: "Four Concealed Triplets", value: 1}
        },
